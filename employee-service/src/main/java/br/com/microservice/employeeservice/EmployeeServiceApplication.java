package br.com.microservice.employeeservice;
...
public class EmployeeServiceApplication {
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.microservice.employeeservice.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(new ApiInfoBuilder().version("1.0").title("Employee API").description("Documentation " +
                        "Employee API v1.0").build());
    }
