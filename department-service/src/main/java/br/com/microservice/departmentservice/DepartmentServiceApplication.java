package br.com.microservice.departmentservice;

import br.com.microservice.departmentservice.model.Department;
import br.com.microservice.departmentservice.repository.DepartmentRepository;
...
public class DepartmentServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.microservice.departmentservice.controller"))
